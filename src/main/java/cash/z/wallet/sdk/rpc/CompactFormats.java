...
public final class CompactFormats {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(cash.z.wallet.sdk.rpc.CompactFormats.CompactBlock result) {
        if (vtxBuilder_ == null) {
      ...
      private void buildPartial0(cash.z.wallet.sdk.rpc.CompactFormats.CompactBlock result) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 58: {
                cash.z.wallet.sdk.rpc.CompactFormats.CompactTx m =
                    input.readMessage(
                        cash.z.wallet.sdk.rpc.CompactFormats.CompactTx.parser(),
                        extensionRegistry);
                if (vtxBuilder_ == null) {
                  ensureVtxIsMutable();
                  vtx_.add(m);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(cash.z.wallet.sdk.rpc.CompactFormats.CompactTx result) {
        if (spendsBuilder_ == null) {
      ...
      private void buildPartial0(cash.z.wallet.sdk.rpc.CompactFormats.CompactTx result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 34: {
                cash.z.wallet.sdk.rpc.CompactFormats.CompactSpend m =
                    input.readMessage(
                        cash.z.wallet.sdk.rpc.CompactFormats.CompactSpend.parser(),
                        extensionRegistry);
                if (spendsBuilder_ == null) {
                  ensureSpendsIsMutable();
                  spends_.add(m);
              ...
              case 42: {
                cash.z.wallet.sdk.rpc.CompactFormats.CompactOutput m =
                    input.readMessage(
                        cash.z.wallet.sdk.rpc.CompactFormats.CompactOutput.parser(),
                        extensionRegistry);
                if (outputsBuilder_ == null) {
                  ensureOutputsIsMutable();
                  outputs_.add(m);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(cash.z.wallet.sdk.rpc.CompactFormats.CompactSpend result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
          result.nf_ = nf_;
        }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(cash.z.wallet.sdk.rpc.CompactFormats.CompactOutput result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
          result.cmu_ = cmu_;
        }
